...
Something about earlier models...
...
Something on bert and followers...
...
In next step we used Empath Client[b], a text analyzing tool with pre-build category set, to compute empath category similarity by mapping labeled sentences in dataset and empath categories using hypernyms. We also map using exact empath emotion category.
